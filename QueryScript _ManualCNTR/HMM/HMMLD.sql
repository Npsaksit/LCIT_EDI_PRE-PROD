 (SELECT
 ECM.VESSEL_NM_AN,
 nvl(decode(TV.EXT_VSL_C,'YCY',TV.EXT_VSL_C||ECM.VOYAGE_AN,
                             'YPX',TV.EXT_VSL_C||ECM.VOYAGE_AN,
                             'KRL',TV.EXT_VSL_C||ECM.VOYAGE_AN,
                             'YCJ',TV.EXT_VSL_C||ECM.VOYAGE_AN,
                             'BRL',TV.EXT_VSL_C||ECM.VOYAGE_AN,ECM.VOYAGE_AN),'')AS VOYAGE_AN,
 ...
 nvl((select tl.CTRY_C || decode(tl.LOC_C,'LA1','LAX','LA2','LAX','LA3','LAX','LA4','LAX','LGB','LAX','SPQ','LAX','SAN','LAX',tl.LOC_C) from tmt_loc tl where tl.loc_c = ECM.POD_CODE), '') AS POD,
 nvl((select tl.CTRY_C || decode(tl.LOC_C,'LA1','LAX','LA2','LAX','LA3','LAX','LA4','LAX','LGB','LAX','SPQ','LAX','SAN','LAX',tl.LOC_C) from tmt_loc tl where tl.loc_c = ECM.POL_CODE), '') AS POL,
 ...
 AND ECM.CNTR_OPERATOR_CODE LIKE ('HMM')
