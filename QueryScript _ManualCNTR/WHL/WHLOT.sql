 ...
 decode(ECM.LADEN_INDICATOR_AN,'F',decode(ECM.DST_CODE,'ESCO','6','LKB','6','SCT','6','3'),'E',decode(ECM.DST_CODE,'MDT','3','SCT','3','TDT','3','UNICON','3','HLA','3','ESCOLKB','3','GFLCH','3','CIMC','3','GFL','3','GFBKK20','3','GFBKK21','3',decode(substr(ECM.DST_CODE,1,2),'GF','3'),'2'),' ') AS EQP_STATUS_CODE,
 ...
 WHERE ECM.CNTR_OPERATOR_CODE IN ('WHL')
 ...
 nvl((SELECT MAX(a.IMCO_AN) from EDI_CNTR_MOVE_HAZ a where a.CNTR_MOVE_ID=ECM.ID),'NODG') AS IMCO,
 (SELECT MAX(a.UNDG_AN) from EDI_CNTR_MOVE_HAZ a where a.CNTR_MOVE_ID=ECM.ID and a.IMCO_AN=(SELECT MAX(b.IMCO_AN) from EDI_CNTR_MOVE_HAZ b where b.CNTR_MOVE_ID=ECM.ID))AS UNDG,
 decode(ECM.OUT_TRANSPORT_MODE_CODE,'GATE','3','RAIL','2','BARGE','8','2')AS OUT_TRANSPORT_MODE_CODE,
