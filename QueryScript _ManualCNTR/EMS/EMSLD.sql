 ...
 nvl(substr((SELECT stragg(a.SEAL_NO_AN) from EDI_CNTR_MOVE_SEAL a WHERE a.SEAL_NO_AN IS NOT NULL AND a.CNTR_MOVE_ID=ECM.ID  AND ROWNUM <=1),1,15),'NOSEAL')AS SEAL,
 ...
 AND ECM.CNTR_OPERATOR_CODE IN ('EMS','HML','LLT','EMC','EGH','EMA')
