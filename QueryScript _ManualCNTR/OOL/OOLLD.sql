 ...
 substr(rpad(decode(nvl(ECM.POD_CODE,' '),'LA1','USLAX','LA2','USLAX','LA3','USLAX','LA4','USLAX','KHH','TWKHH','OAK','USOAK','SIN','SGSIN','HKG','HKHKG','SAN','USLAX',' '),5,' '),1,5) AS POD,
 ...
 AND ECM.CNTR_OPERATOR_CODE LIKE ('OOL')
