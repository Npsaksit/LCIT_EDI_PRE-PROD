 ...
 substr(rpad(decode(nvl(ECM.DST_CODE, ' '),'LICD','BKK10','SCT','BKK07','LCIT','LCB05','ECT','BKK08','LCD','LCB03','TIPS','LCB02','MON','BKK03','LCT','BKK12','BKK50'),5,' '),1,5)AS DST_CODE,
 ...
 WHERE ECM.CNTR_OPERATOR_CODE IN ('OOL')
