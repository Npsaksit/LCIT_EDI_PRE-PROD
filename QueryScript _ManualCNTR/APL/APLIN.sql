...
SELECT 
 ...
 WHERE ECM.CNTR_OPERATOR_CODE LIKE 'APL'
...
SELECT 
 ...
 ECM.CNTR_AN,
 ECM.CONTAINER_TYPE_CODE,
 (SELECT stragg(a.SEAL_NO_AN) from EDI_CNTR_MOVE_SEAL a WHERE a.SEAL_NO_AN IS NOT NULL AND a.CNTR_MOVE_ID=ECM.ID) AS SEAL, 
 decode(ECM.EQP_STATUS_CODE,'OB','2','IB','3',' ')AS EQP_STATUS_CODE,
 decode(ECM.LADEN_INDICATOR_AN,'E','4','F','5',' ')AS LADEN_INDICATOR_AN,
 ...
 AND ECM.CNTR_OPERATOR_CODE LIKE 'APL'
