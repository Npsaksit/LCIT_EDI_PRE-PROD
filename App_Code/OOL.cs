...
// -----------------For Content Query Data form EdiTB.Rows[checkdtb]["COLUMNS_NAME"]  -----------------------------
							...
							for(int checkdtb =0 ;checkdtb < EdiTB.Rows.Count; checkdtb++)
							{
								...
								Console.WriteLine("DTM+201:"+EdiTB.Rows[checkdtb]["ACTIVITY_TM"].ToString()+":303'");
								countSegment++;
								...
								{
									Console.WriteLine("SEL+ZZZ+:::"+EdiTB.Rows[checkdtb]["SEAL"].ToString()+"'");
									countSegment++;
								}
								...
								Console.WriteLine("TDT+20++"+EdiTB.Rows[checkdtb]["IN_TRANSPORT_MODE_CODE"].ToString()+"+++++:::"+EdiTB.Rows[checkdtb]["INLAND_CARR_TP_MEAN_CODE"]+"'");
								countSegment++;
...
// ---------------------------------------------- END OF CREATE EDI FILE PROCESS --------------------------------------------
			...
			case "OT":
				...
				EDIHeader=	"UNB+UNOA:1+"+SenderID+"+"+ReceiveID+"+"+dt.ToString("yyMMdd")+":"+dt.ToString("HHmm")+"+"+"LO++CODECO'\r\n"+
							"UNH+"+dt.ToString("yyyyMMddHH")+"+CODECO:D:95B:UN'\r\n"+
							"BGM+662+CONTAINER GATE IN/OUT+9'\r\n"+
							// "TDT+20+"+EdiTB.Rows[0]["VOYAGE_AN"].ToString()+"+1+++++"+EdiTB.Rows[0]["VISIT_VSL_CALL_SIGN_C"].ToString()+":103'\r\n"+
							"TDT+20++1+++++:103'\r\n"+
							"LOC+15+"+terminal.ToString()+"'\r\n"+
							"NAD+MS+LCIT'\r\n";
				...
				for(int checkdtb =0 ;checkdtb < EdiTB.Rows.Count; checkdtb++)
				{
					...
					Console.WriteLine("DTM+191:"+EdiTB.Rows[checkdtb]["ACTIVITY_TM"].ToString()+":303'");
					countSegment++;
					...
					Console.WriteLine("TDT+20++"+EdiTB.Rows[checkdtb]["OUT_TRANSPORT_MODE_CODE"].ToString()+"+++++:::"+EdiTB.Rows[checkdtb]["INLAND_CARR_TP_MEAN_CODE"]+"'");
					countSegment++;
...
EDIHeader = "UNB+UNOA:1+"+SenderID+"+"+ReceiveID+"+"+dt.ToString("yyMMdd")+":"+dt.ToString("HHmm")+"+"+"LO++COARRI'\r\n"+
			  ...
			  "BGM+03+Discharge/Loading report+9'\r\n"+
		...
		MoveFile(SaveEDIfile);
			...
			case "DG":
				EDIHeader = "UNB+UNOA:1+"+SenderID+"+"+ReceiveID+"+"+dt.ToString("yyMMdd")+":"+dt.ToString("HHmm")+"+"+"DI++COARRI'\r\n"+
							"UNH+"+dt.ToString("yyyyMMddHH")+"+COARRI:D:95B:UN'\r\n"+
						    "BGM+02+Discharge/Loading report+9'\r\n"+
							"TDT+20+"+EdiTB.Rows[0]["VOYAGE_AN"].ToString()+"+1+++++"+EdiTB.Rows[0]["VISIT_VSL_CALL_SIGN_C"].ToString()+":103::"+EdiTB.Rows[0]["VESSEL_NM_AN"].ToString()+"'\r\n"+
							"LOC+11+"+terminal.ToString()+"'\r\n"+
							"NAD+MS+LCIT'\r\n";
