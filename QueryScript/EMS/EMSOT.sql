 ...
 nvl(ltrim(translate(ECM.MASTER_BOL_AN,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz','                                                    ')), 'NOBL')  AS MASTER_BOL_AN,
 ...
 WHERE ECM.CNTR_OPERATOR_CODE IN ('EMS','HML','LLT','EMC','EGH','EMA')
