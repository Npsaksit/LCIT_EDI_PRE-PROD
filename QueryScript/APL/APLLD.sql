SELECT
 ...
 substr(translate(nvl((SELECT a.SHPR_N from TMS_CNTR_HIST a where a.CNTR_SEQ=ECM.CNTR_SEQ AND a.CNTR_AN=ECM.CNTR_AN),'NO'), '!@#$%^&*-+|\/[]{}<>?', '                    '),1,35) AS SHIPPER,
 ECM.CNTR_AN,
 ...
 decode(ECM.EQP_STATUS_CODE,'OB','2','IB','3','2') AS EQP_STATUS_CODE,
