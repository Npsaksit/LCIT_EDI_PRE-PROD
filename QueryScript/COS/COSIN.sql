 ...
 nvl(decode(ECM.LADEN_INDICATOR_AN,'E',ECM.BOOKING_NO_AN,ltrim(translate(ECM.BOOKING_NO_AN,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-','0123456789                           '))),'NOBOOKING') AS BOOKING_NO_AN,
 ...
 nvl(ECM.AREA_C,'B5') AS AREA_C
 FROM TMS_OWNER.EDI_CNTR_MOVE ECM
 WHERE UPPER(ECM.CNTR_OPERATOR_CODE) IN ('COS','CSE')
