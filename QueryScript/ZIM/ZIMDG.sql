 ...
 decode(nvl((select tl.CTRY_C || tl.LOC_C from tmt_loc tl where tl.loc_c = ECM.POL_CODE), ' '),'MYPKL','MYPKG','VNHCM','VNSGN','CNYAH','CNSHA','CNWXK','CNSHA',nvl((select tl.CTRY_C || tl.LOC_C from tmt_loc tl where tl.loc_c = ECM.POL_CODE), '')) AS POL,
 decode(nvl((select tl.CTRY_C || tl.LOC_C from tmt_loc tl where tl.loc_c = ECM.POD_CODE), ' '),'MYPKL','MYPKG','VNHCM','VNSGN','CNYAH','CNSHA','CNWXK','CNSHA',nvl((select tl.CTRY_C || tl.LOC_C from tmt_loc tl where tl.loc_c = ECM.POD_CODE), '')) AS POD,
 ...
 AND UPPER(ECM.CNTR_OPERATOR_CODE) LIKE UPPER('ZIM')
