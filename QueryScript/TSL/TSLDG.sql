 ...
 ROUND(ECM.TARE_WEIGHT) AS TARE_WEIGHT,
 ...
 ECM.DAMAGE_SEGMENT_DS,
 nvl(ECM.AREA_C,'B5') AS AREA_C,
 DECODE(ECM.CNTR_LOAD_STATUS_CODE,'F','2','L','3','') AS CNTR_LOAD_STATUS_CODE
 FROM EDI_CNTR_MOVE ECM, TMV_VESSEL_VISIT TV
 WHERE  ECM.TRGT_VVD_N = TV.VESSEL_VISIT_C
 AND UPPER(ECM.CNTR_OPERATOR_CODE) LIKE UPPER('TSL')
